...
Copyright (C) 2022 Strudel contributors - see <https://github.com/k4ran909/NeuroRAVE/blob/main/repl/src/App.js>
...
export function useReplContext() {
  ...
  const init = useCallback(() => {
    ...
    initCode().then(async (decoded) => {
      ...
      editor.setCode(code);
      setDocumentTitle(code);
      logger(`Welcome to Neuro RAVE! ${msg} Press play or hit ctrl+enter to run it!`, 'highlight');
    });
  ...
  const setDocumentTitle = (code) => {
    ...
    document.title = (meta.title ? `${meta.title} - ` : '') + 'Neuro RAVE';
  };
