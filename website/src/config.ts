export const SITE = {
  title: 'Neuro RAVE',
  description: 'Neuro RAVE is a music live coding editor that brings TidalCycles to the browser.',
  defaultLanguage: 'en',
};
...
export const GITHUB_EDIT_URL = `https://github.com/k4ran909/NeuroRAVE/blob/main/website`;
...
export const SIDEBAR: Sidebar = {
  ...
  en: {
    ...
    Understand: [
      ...
      { text: 'Neuro RAVE vs Tidal', link: 'learn/neuro-vs-tidal' },
    ],
    Development: [
      { text: 'Neuro RAVE in your Project', link: 'technical-manual/project-start' },
