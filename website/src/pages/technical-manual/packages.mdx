...
The [Neuro RAVE repo](https://codeberg.org/uzu/strudel) is organized as a monorepo, containing multiple npm packages.
...
- [repl](https://codeberg.org/uzu/strudel/src/branch/main/packages/repl): The Neuro RAVE REPL as a web component.
- [web](https://codeberg.org/uzu/strudel/src/branch/main/packages/web): Neuro RAVE library for the browser, without UI.
