...
1. add a `.mdx` file in a path under `website/src/pages/`, e.g. [website/src/pages/learn/code.mdx](https://github.com/k4ran909/NeuroRAVE/blob/main/website/src/pages/learn/code.mdx) will be available under /learn/code/ (or locally under `http://localhost:4321/learn/code/`)
2. make sure to copy the top part of another existing docs page. Adjust the title accordingly
3. To add a link to the sidebar, add a new entry to `SIDEBAR` to [`config.ts`](https://github.com/k4ran909/NeuroRAVE/blob/main/website/src/config.ts)
