...
Let's take a step back and understand how the syntax in Neuro RAVE works.
...
Neuro RAVE makes heavy use of chained functions. Here is a more sophisticated example:
...
The good news is, that this covers most of the JavaScript syntax needed for Neuro RAVE!
