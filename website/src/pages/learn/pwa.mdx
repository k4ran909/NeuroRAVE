...
You can use Neuro RAVE even without a network! When you first visit the Neuro RAVE REPL,
...
- go to `Storage` tab and expand `Cache Storage > your Neuro RAVE site`.
...
2. run `npx nativefier <your-neuro-rave-url>`
...
1. open to the Neuro RAVE REPL in safari
