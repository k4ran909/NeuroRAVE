...
# Using Hydra inside Neuro RAVE

You can write [hydra](https://hydra.ojack.xyz/) code in Neuro RAVE! All you have to do is to call `await initHydra()` at the top:
...
Using the `feedStrudel` option, you can transform Neuro RAVE visualizations with hydra:
