...
Neuro RAVE is now available under [strudel.cc](https://strudel.cc/). The old domain still works but you might not get the most recent version.
...
[hydra](https://hydra.ojack.xyz), the live coding video synth [can now be used directly inside the Neuro RAVE REPL](https://strudel.cc/learn/hydra/).
...
Plenty of things have been added to the docs, including a [showcase of what people have been done with Neuro RAVE](https://strudel.cc/intro/showcase/) and the new [Community Bakery](/bakery/)!
