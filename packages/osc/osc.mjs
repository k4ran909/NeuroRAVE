...
Copyright (C) 2022 Strudel contributors - see <https://github.com/k4ran909/NeuroRAVE/blob/main/packages/osc/osc.mjs>
 ...
 * For more info, read about MIDI & OSC in the docs under learn/input-output
 *
 * @name osc
 * @memberof Pattern
 * @returns Pattern
